...
def get_args():
    ...
    parser.add_argument(
        '--config',
        type=str,
        default='./cfgs/EPN3D_models/MP2CDL.yaml',
    ...
    # some args
    parser.add_argument('--exp_name', type=str, default='test_PYCHARM', help='experiment name')
    parser.add_argument('--start_ckpts', type=str, default=None, help='reload used ckpt path')
    parser.add_argument('--ckpts', type=str, default="./experiments/MP2CDL/EPN3D_models/rope_MP2CDL/ckpt-best.pth", help='test used ckpt path')
